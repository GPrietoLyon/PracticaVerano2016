pro global_bc03, write_paramfile=write_paramfile, build_grids=build_grids, $
...
;Paso 0, Definir informacion
    prefix = 'zd'
    isedfit_dir = '/home/ptroncos/verano2017/fit_bc03/Frontierv6/'
...
; write the parameter file (Definir parametros, ajustar solo esto)
    if keyword_set(write_paramfile) then begin
       write_isedfit_paramfile, params=params, isedfit_dir=isedfit_dir, $
         ...
         nmodel=40000L, age=[0.001,13.5], tau=[0.001,13.5], Zmetal=[0.0004,0.05], $
